...
i.npo <- 2       # 1,2,3 for # of potential outcome
set.seed(6234567 + i.gen.da * 1000 + i.xi * 100 + i.a * 10 + i.npo)
...
# for(i.gen.da in 1:2){
  ...
  fn <- paste("./results_oc_pval_ntrt/08s0-oc_",
              "genda_", i.gen.da, "_xi_", i.xi, "_a_", i.a,
              "_po_", i.npo, "_ntrt_", n.trt, ".rda",
              sep = "")
